...
<div id="wg-approval-dialog" class="gallery-top-controls" data-approved="<?php echo $accepted ? '1' : '0'; ?>">
    ...
    <div class="wg-approval-left">
        ...
        <div id="wg-approved-badge" style="<?php echo $accepted ? '' : 'display:none;'; ?>">
    ...
    <select class="wg-download-select zip-download-select <?php echo $accepted ? '' : 'disabled'; ?>"
        ...
        <option value="<?php echo esc_url(admin_url("admin-ajax.php?action=wg_download_zip&gallery_id={$post_id}&type=web")); ?>">Download Web</option>
        <option value="<?php echo esc_url(admin_url("admin-ajax.php?action=wg_download_zip&gallery_id={$post_id}&type=original")); ?>">Download Original</option>
        <option value="<?php echo esc_url(admin_url("admin-ajax.php?action=wg_download_zip&gallery_id={$post_id}&type=both")); ?>">Download Begge</option>
    </select>
</div>